...
import kotlinx.android.synthetic.main.fragment_business_news.paginationProgressBar
...
class EntertainmentNewsFragment: Fragment(R.layout.fragment_entertainment_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_entertainmentNewsFragment_to_articleNavFragment,
                bundle
            )
        }
    ...
    val scrollListener =  object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaginate) {
                viewModel.getEntertainmentNews("business")
                isScrolling = false
            }
        }
