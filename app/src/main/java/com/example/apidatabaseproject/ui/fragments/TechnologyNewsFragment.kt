...
import com.example.apidatabaseproject.adapters.NewsAdapter
...
import com.example.apidatabaseproject.util.Constants
import com.example.apidatabaseproject.util.Resource
import kotlinx.android.synthetic.main.fragment_entertainment_news.*
import kotlinx.android.synthetic.main.fragment_entertainment_news.paginationProgressBar
...
class TechnologyNewsFragment: Fragment(R.layout.fragment_technology_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                R.id.action_technologyNewsFragment_to_articleNavFragment,
                bundle
            )
        }
            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages = newsResponse.totalResults / Constants.QUERY_PAGE_SIZE + 2 //integer divison that is always rounded off so we add 1, and 1 more because our last page is always empty
    ...
    val scrollListener =  object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaginate) {
                viewModel.getTechnologyNews("business")
                isScrolling = false
            }
        }
    ...
    private fun setUpRecyclerView() {
        ...
        rvTechnologyNews.apply{
            ...
            addOnScrollListener(this@TechnologyNewsFragment.scrollListener)
        }
    }
}